	...
	while ($row_board = mysql_fetch_assoc($result_boards))
	{
		...
		$this_last_post = array(
			...
			'member' => array(
				...
				'href' => $mhref,
				'link' => $row_board['poster_name'] != '' ? (!empty($row_board['id_member']) ? '<a class="member" attr-mid="'.$row_board['id_member'].'" href="'.$mhref.'">' . $row_board['real_name'] . '</a>' : $row_board['real_name']) : $txt['not_applicable'],
			),
