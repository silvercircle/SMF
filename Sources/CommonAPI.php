			...
			$this->topiclist[$row['id_topic']] = array(
				...
				'first_post' => array(
					...
					'member' => array(
						...
						'link' => !empty($row['id_member']) ? '<a class="member" attr-mid="'.$row['id_member'].'" href="' . $f_post_mem_href . '" title="' . $txt['profile_of'] . ' ' . $row['first_member_name'] . '">' . $row['first_member_name'] . '</a>' : $row['first_member_name'],
					),
				...
				'last_post' => array(
					...
					'member' => array(
						...
						'link' => !empty($row['id_member_updated']) ? '<a class="member" attr-mid="'.$row['id_member_updated'].'" href="' . $l_post_mem_href . '">' . $row['last_real_name'] . '</a>' : $row['last_real_name']
					),
