				...
				$context['topics'][$row['id_topic']] = array(
					...
					'first_post' => array(
						'member' => array(
							...
							'link' => !empty($row['first_id_member']) ? '<a class="member" attr-mid="'.$row['id_member_started'].'" href="' . $f_post_mem_href . '" title="' . $txt['profile_of'] . ' ' . $row['first_display_name'] . '">' . $row['first_display_name'] . '</a>' : $memberContext[$memID]['name'],
...
function statPanel($memID)
{
	...
	EoS_Smarty::loadTemplate('profile/profile_base');
	EoS_Smarty::getConfigInstance()->registerHookTemplate('profile_content_area', 'profile/stats');
}
