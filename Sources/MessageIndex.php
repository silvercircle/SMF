...
function MessageIndex()
{
	...
	if(!empty($context['topics'])) {
		$context['subject_sort_header'] = '<a rel="nofollow" href="' . $scripturl . '?board=' . $context['current_board'] . '.' . $context['start'] . ';sort=subject' . ($context['sort_by'] == 'subject' && $context['sort_direction'] == 'up' ? ';desc' : '') . '">' . $txt['subject'] . ($context['sort_by'] == 'subject' ? ($context['sort_direction'] == 'up' ? '&nbsp;&#x25B2;' : '&nbsp;&#x25BC;') : '') . '</a> / <a rel="nofollow" href="' . $scripturl . '?board=' . $context['current_board'] . '.' . $context['start'] . ';sort=starter' . ($context['sort_by'] == 'starter' && $context['sort_direction'] == 'up' ? ';desc' : '') . '">' . $txt['started_by'] . ($context['sort_by'] == 'starter' ? ($context['sort_direction'] == 'up' ? '&nbsp;&#x25B2;' : '&nbsp;&#x25BC;') : '') . '</a>';
		$context['views_sort_header'] = '<a rel="nofollow" href="' . $scripturl . '?board=' . $context['current_board'] . '.' . $context['start'] . ';sort=replies' . ($context['sort_by'] == 'replies' && $context['sort_direction'] == 'up' ? ';desc' : '') . '">' . $txt['replies'] . ($context['sort_by'] == 'replies' ? ($context['sort_direction'] == 'up' ? '&nbsp;&#x25B2;' : '&nbsp;&#x25BC;') : '') . '</a> / <a href="' . $scripturl . '?board=' . $context['current_board'] . '.' . $context['start'] . ';sort=views' . ($context['sort_by'] == 'views' && $context['sort_direction'] == 'up' ? ';desc' : '') . '">' . $txt['views'] . ($context['sort_by'] == 'views' ? ($context['sort_direction'] == 'up' ? '&nbsp;&#x25B2;' : '&nbsp;&#x25BC;') : '') . '</a>';
		$context['lastpost_sort_header'] = '<a rel="nofollow" href="'. $scripturl . '?board=' . $context['current_board'] . '.' . $context['start'] . ';sort=last_post' . ($context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '') . '">' . $txt['last_post'] . ($context['sort_by'] == 'last_post' ? ($context['sort_direction'] == 'up' ? '&nbsp;&#x25B2;' : '&nbsp;&#x25BC;')  : '') . '</a>';
