...
function template_credits()
{
	...
	echo '<br />
		<div class="cat_bar">
			<h3>
				<span class="ie6_header floatleft"><a href="', $scripturl, '?action=helpadmin;help=latest_support" onclick="return reqWin(this.href);" class="help"><strong>[',$txt['help'],']</strong>&nbsp;&nbsp;</a> ', $txt['support_latest'], '</span>
			</h3>
		</div>
		<div class="blue_container">
			<div class="content">
	...
	foreach ($context['config_vars'] as $config_var)
	{
				...
				echo '
					<br /><div class="cat_bar">
						<h3', !empty($config_var['force_div_id']) ? ' id="' . $config_var['force_div_id'] . '"' : '', '>
							', ($config_var['help'] ? '<a href="' . $scripturl . '?action=helpadmin;help=' . $config_var['help'] . '" onclick="return reqWin(this.href);" class="help"><strong>['.$txt['help'].']</strong>&nbsp;&nbsp;</a>' : ''), '
							', $config_var['label'], '
						</h3>
					</div>';
			}
		...
		if (is_array($config_var))
		{
			...
			else
			{
				...
				if ($config_var['help'])
					echo '
							<a id="setting_', $config_var['name'], '" href="', $scripturl, '?action=helpadmin;help=', $config_var['help'], '" onclick="return reqWin(this.href);" class="help"><strong>[',$txt['help'],']&nbsp;&nbsp;</strong></a><span', ($config_var['disabled'] ? ' style="color: #777777;"' : ($config_var['invalid'] ? ' class="error"' : '')), '><label for="', $config_var['name'], '">', $config_var['label'], '</label>', $subtext, ($config_var['type'] == 'password' ? '<br /><em>' . $txt['admin_confirm_password'] . '</em>' : ''), '</span>
						</dt>';
				else
					echo '
...
function template_edit_profile_field()
{
				...
				<div class="content">
					<fieldset>
						...
						<dl class="settings">
							...
							<dt>
								<a id="field_show_enclosed" href="', $scripturl, '?action=helpadmin;help=field_show_enclosed" onclick="return reqWin(this.href);" class="help"><strong>[',$txt['help'],']&nbsp;&nbsp;</strong></a>
					...
					<fieldset>
						...
						<dl class="settings">
							...
							<dt id="options_dt">
								<a href="', $scripturl, '?action=helpadmin;help=customoptions" onclick="return reqWin(this.href);" class="help"><strong>[',$txt['help'],']&nbsp;&nbsp;</strong></a>
	...
	echo '
					...
					<fieldset>
						...
						<dl class="settings">
							<dt id="mask_dt">
								<a id="custom_mask" href="', $scripturl, '?action=helpadmin;help=custom_mask" onclick="return reqWin(this.href);" class="help"><strong>[',$txt['help'],']&nbsp;&nbsp;</strong></a>
