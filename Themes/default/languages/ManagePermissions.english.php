...
$txt['permissionname_post_sticky'] = 'Set posts sticky and select alternative layout';
$txt['permissionhelp_post_sticky'] = 'This permission allows users to mark posts as sticky and select a different layout for the first post of a topic. Sticky posts will appear on top of each topic page.';
...
$txt['permissionname_profile_signature'] = 'Create or modify forum signature';
$txt['permissionhelp_profile_signature'] = 'This permission is required to allow a user to create or modify a forum signature. You may wish to disable this for new users to prevent signature spam.';
