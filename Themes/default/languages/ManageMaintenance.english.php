...
$txt['maintain_template_cache'] = 'Clean all compiled templates';
$txt['maintain_template_cache_info'] = 'This function will clear all compiled templates and force the template engine to regenerate them on next usage.';
