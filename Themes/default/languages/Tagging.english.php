...
$txt['smftags_tagtoadd'] = 'Tag(s) to add:';

//Tags Admin Settings
$txt['smftags_set_mintaglength'] = 'Minimum length for a tag (in characters)';
$txt['smftags_set_maxtaglength'] = 'Maximum length for a tag (in characters)';
$txt['smftags_set_maxtags'] = 'Maximum number of tags a topic can have';
...
$txt['smftags_err_mintag'] = 'The tag is too short. It must have a minimum of %d characters.';
$txt['smftags_err_maxtag'] = 'The tag is too long. It must not exceed the maximum of %d characters.';
...
$txt['smftags_err_alreadyexists'] = 'A tag with this name already exists on this topic.';

$txt['smftags_pages'] = 'Pages: ';
$txt['smftags_savesettings'] = 'Save Settings';

$txt['smftags_addtag'] = 'Add tag';
$txt['smftags_seperate'] = 'Seperate tags by commas';
