...
$txt['socialsettings_desc'] = 'Here you can configure a few settings for integrating various social media features.<br />Note that the <strong>share topic</strong> feature is controlled by board permissions and that registered users can opt-out from seeing social media content.';
...
$txt['embed_piwik'] = 'Embed Piwik analytics code into the theme. You <b>must</b> set the full URL and tracker ID below.';
$txt['piwik_uri'] = 'The full base URL to the piwik installation you want to use';
$txt['piwik_tracker_id'] = 'The id of the piwik tracker you want to use for this forum.';
...
$txt['core_settings_item_ts'] = 'Tagging system';
$txt['core_settings_item_ts_desc'] = 'This feature allows to add tags to topics. Tags are an easy way to organize topics into virtual categories.';
