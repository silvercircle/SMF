...
$txt['mboards_automerge'] = 'Automatically merge posts by same member';
$txt['mboards_automerge_desc'] = 'If set, posts by the same member at the end of a topic will be merged into one post. The number determines the maximum age (in minutes) and if the current last post in the topic is older, no merging will happen.';
