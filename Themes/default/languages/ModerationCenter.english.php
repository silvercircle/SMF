...
$txt['mc_modreport_whoreported_data'] = '<strong>Reported by</strong> %1$s, %2$s.<br><strong>Reason:</strong> ';
...
$txt['mc_topicban_missing_reason'] = 'A reason for the ban must be entered.';
...
$txt['mc_topicban_reason'] = 'Reason for banning the member:';
...
$txt['mc_view_topicbans_all'] = 'Display all topic bans';
$txt['mc_view_topicbans_bymember'] = 'Viewing topic bans for member %s';
$txt['mc_view_topicbans_bytopic'] = 'Viewing topic bans for topic %s';
$txt['mc_topicbans_view'] = 'View topic bans';
$txt['mc_topicbans_view_desc'] = 'Browse existing topic bans';
$txt['mc_topicban_list_empty'] = 'No topic bans found';
$txt['mc_topicban_list_issue_time'] = 'Ban issue time';
$txt['mc_topicbans_notopic'] = 'No topic specified';
$txt['mc_topicbans_nomember'] = 'No member id given';
$txt['mc_topicban_reason'] = 'Reason';
$txt['mc_topicban_reason_see'] = 'View message';
$txt['mc_topicban_is_perma'] = 'Ban is <strong>permanent</strong>';
$txt['mc_topicban_hours_left'] = 'hours left';
$txt['mc_topicban_expires'] = 'Set to expire';