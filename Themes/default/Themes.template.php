...
function template_main()
{
	...
	<div id="admincenter">
		<form action="', $scripturl, '?action=admin;area=theme;sa=admin" method="post" accept-charset="', $context['character_set'], '">
			...
			<div class="cat_bar">
				<h3>
					<span class="ie6_header floatleft"><a href="', $scripturl, '?action=helpadmin;help=themes" onclick="return reqWin(this.href);" class="help"><strong>[',$txt['help'],']&nbsp;&nbsp;</strong></a>
	...
	echo '
		...
		<div class="cat_bar">
			<h3>
				<span class="ie6_header floatleft"><a href="', $scripturl, '?action=helpadmin;help=latest_themes" onclick="return reqWin(this.href);" class="help"><strong>[',$txt['help'],']&nbsp;&nbsp;</strong></a> ', $txt['theme_latest'], '</span>
			</h3>
		</div>
	...
	if (!$context['can_create_new'])
		...
		<form action="', $scripturl, '?action=admin;area=theme;sa=install" method="post" accept-charset="', $context['character_set'], '" enctype="multipart/form-data" onsubmit="return confirm(\'', $txt['theme_install_new_confirm'], '\');">
			<div class="cat_bar">
				<h3>
					<span class="ie6_header floatleft"><a href="', $scripturl, '?action=helpadmin;help=theme_install" onclick="return reqWin(this.href);" class="help"><strong>[',$txt['help'],']&nbsp;&nbsp;</strong></a> ', $txt['theme_install'], '</span>
				</h3>
			</div>
			<div class="blue_container cleantop">
				<div class="content">
...
function template_list_themes()
{
	...
	<div id="admincenter">
		<div class="cat_bar">
			<h3>', $txt['themeadmin_list_heading'], '</h3>
		</div>
		<div class="orange_container cleantop mediumpadding">
...
function template_reset_list()
{
	...
	<div id="admincenter">
		<div class="cat_bar">
			<h3>', $txt['themeadmin_reset_title'], '</h3>
		</div>
		<div class="orange_container cleantop mediumpadding">
...
function template_set_settings()
{
	...
	<div id="admincenter">
		<form action="', $scripturl, '?action=admin;area=theme;sa=settings;th=', $context['theme_settings']['theme_id'], '" method="post" accept-charset="', $context['character_set'], '">
			<div>
				<h1 class="bigheader">
					<a href="', $scripturl, '?action=helpadmin;help=theme_settings" onclick="return reqWin(this.href);" class="help"><strong>[',$txt['help'],']&nbsp;&nbsp;</strong></a> ', $txt['theme_settings'], ' - ', $context['theme_settings']['name'], '
				</h1>
			</div>
			<br class="clear">';
...
function template_pick()
{
	...
	foreach ($context['available_themes'] as $theme)
	{
		echo '
			...
			<div class="cleantop ', $theme['selected'] ? 'red_container' : 'blue_container', '">
...
function template_edit_list()
{
	...
	<div id="admincenter">
		<div>
			<h1 class="bigheader">', $txt['themeadmin_edit_title'], '</h1>
		</div>';
...
function template_copy_template()
{
	...
	<div id="admincenter">
		<div class="cat_bar">
			<h3>', $txt['themeadmin_edit_filename'], '</h3>
		</div>
...
function template_edit_browse()
{
	...
	echo '
	<div id="admincenter">
		<table class="table_grid mediumpadding" id="mlist" style="width:100%;">
		<thead>
			<tr>
				<th class="lefttext red_container" scope="col">', $txt['themeadmin_edit_filename'], '</th>
				<th class="centertext red_container scope="col">', $txt['themeadmin_edit_modified'], '</th>
				<th class="lefttext red_container scope="col">', $txt['themeadmin_edit_size'], '</th>
			</tr>
		</thead>
		<tbody>';
