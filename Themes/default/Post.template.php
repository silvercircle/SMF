	...
	echo '
					<div id="postMoreOptions" class="smalltext">
						<ul class="post_options">
							...
							', isset($context['can_stick_firstpost']) && !empty($context['can_stick_firstpost']) ? '<li><label for="stickfirst"><input type="checkbox" name="stickfirst" id="stickfirst" value="1" class="input_check" '.($context['first_is_sticky'] ? 'checked="checked"' : '') . ' /> ' . $txt['first_post_sticky'] . '</label></li>' : '', '
