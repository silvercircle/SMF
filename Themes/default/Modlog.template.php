...
function template_main()
{
		...
		<form action="', $scripturl, '?action=modlog2" method="post">
			...
			<div class="tborder">
				<table border="0" cellspacing="1" cellpadding="4" width="100%">
					<tr class="titlebg">
						<td>
							<div style="float: left;"><a href="', $scripturl, '?action=helpadmin;help=15" onclick="return reqWin(this.href);" class="help"><img src="' . $settings['images_url'] . '/helptopics.gif" alt="' . $txt['help'] . '" border="0" align="top" /></a> ', $txt['modlog_moderation_log'], '</div>
	...
	foreach ($context['columns'] as $column)
	{
		...
		else
		{
			...
			if ($column['selected'])
				echo '<b>', $column['label'], '</b> <img src="', $settings['images_url'], '/sort_', $context['sort_direction'], '.gif" alt="" border="0" />';
			else
				echo $column['label'];
			echo '</a></td>';
		}
				...
				<table border="0" cellspacing="1" cellpadding="4" width="100%">
					<tr class="titlebg">
						<td align="right" valign="bottom">
							...
							<input type="text" name="search" size="15" style="margin: 4px 4px 0px 0px;" /><input type="submit" value="', $txt['modlog_go'], '" />
						</td>
					</tr>';
